...
import { XCircle, LogOut, Sun, Moon } from "lucide-react";
...
export default function AccessDeniedPage() {
  ...
  if (loading || !user || appUser?.status !== "rejected") {
    return (
      <div 
      ...
      <main className="flex-1 flex flex-col items-center justify-center px-4 -mt-12">
        <div className="text-center max-w-md">
          ...
          <p 
            ...
            style={{ color: "var(--text-muted)" }}
          >
            Your request to access KirokuMD has been declined by an administrator.
          </p>
